...
export const uiCopy = {
  en: {
    ...
    footer: {
      ...
      copyright: "© 2025 Digital Parents. Independent project by Razvan Costache.",
      linkedin: "Connect on LinkedIn →"
    },
    header: {
      switchTo: "RO"
...
export function getDirectorySubtitle(slug: string, locale: Locale) {
  const subtitles = {
    en: {
    ...
    ro: {
      smartphone: "Ghid de configurare + 8 semnale de risc",
      tablet: "Ghid de configurare + 5 semnale de risc",
      laptop: "Ghid de configurare + 6 semnale de risc",
      desktop: "Ghid de configurare + 4 semnale de risc",
      ios: "Screen Time + controale Family",
      android: "Family Link + Digital Wellbeing",
      windows: "Configurare Family Safety",
      macos: "Screen Time pe desktop"
    }
  } as const;

  return subtitles[locale][slug as keyof typeof subtitles.en];
}
